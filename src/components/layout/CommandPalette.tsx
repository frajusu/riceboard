...
export function CommandPalette() {
  ...
  const commands: CommandItem[] = [
    ...
    {
      id: "bg-glyph",
      label: "Background: Glyph Rain",
      icon: <Layers className="h-4 w-4" />,
      action: () => { setBackgroundPattern("glyph"); toggleCommandPalette(); },
      category: "Background",
    },
    {
      id: "bg-hexfloat",
      label: "Background: Hex Float",
      icon: <Layers className="h-4 w-4" />,
      action: () => { setBackgroundPattern("hexfloat"); toggleCommandPalette(); },
      category: "Background",
    },
    {
      id: "bg-blaze",
      label: "Background: Blaze",
      icon: <Layers className="h-4 w-4" />,
      action: () => { setBackgroundPattern("blaze"); toggleCommandPalette(); },
      category: "Background",
    },
    {
      id: "bg-none",
